...
|-------|------|-------|-----------|-----------|
| **1** | `phase-1/SKILL.md` + `references/phase-1-walkthrough.md` | Stage A: 1a-1u, Stage B: 2a-2f (with Setup-E multi-select special cases) | Dashboard Complexity Score (0-6) + `state.md` created | Always |
